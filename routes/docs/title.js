...
module.exports = [
  {
    ...
    handler: async function (request, reply) {
      ...
      const data = await plt.find_student_data_for_title(role_index);
  ...
  },
  {
    ...
    handler: async function (request, reply) {
      ...
      const data = await plt.find_student_data_for_title_kz(role_index);
      if (!data) return reply.notFound(cert_id_not_found_msg);
